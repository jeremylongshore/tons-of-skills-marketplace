...
description: >-
  Migrate Adobe integrations away from Service Account JWT, Photoshop v1, retired Lightroom Firefly Services, or drifting SDK/API contracts with canaries and rollback. Use when this Adobe operator workflow is needed. Trigger with "upgrade Adobe integration", "migrate Adobe JWT", or "Photoshop v2 migration".
